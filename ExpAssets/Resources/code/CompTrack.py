...
class CompTrack(EnvAgent):
    ...
    #       but, FYI till then, this is a depressingly hardcoded method of setting input bounds
    #       ideally, this should programatically set the maximal value generated by forcing function
    #       the method for which evades me
